...
tonic_activation = [0 0 0 0 2 0 4]';
...
if do_export
    export_fig('steady_state_values_fb_nofb2.pdf')
end
...
axis square
set(gca,'XLim',[400 1200],'TickDir','out','YLim',[0 10]);

if do_export
    export_fig('examples_nofb2.pdf')
end
%% Rerun simulation assuming lower/higher baseline FBN states (given by the value of the tonic input into the FBN)

tonic_activation_low = [0 0 0 0 2 0 4]';
tonic_activation_high = [0 0 0 0 4 0 4]';
Jkcs = 0.9;
...
set(gca,'XLim',[400 1200],'TickDir','out','YLim',[0 5]);
legend({'Low FBN Baseline', 'High FBN Baseline'});
if do_export
    export_fig('baseline_comparison_nofb2.pdf')
end
...
axis square
if do_export
    export_fig('high_baseline_ss_values_nofb2.pdf')
end
%%
figure('Color','w'); hold on;
for ii = 1:length(Jkcs)
...
set(gca,'XLim',[400 1200],'TickDir','out','YLim',[0 10]);
if do_export
    export_fig('high_baseline_examples_nofb2.pdf')
end
